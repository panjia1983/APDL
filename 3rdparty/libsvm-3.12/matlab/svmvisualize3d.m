function svmvisualize3d(label_matrix, instance_matrix, model_name, scaler_name, use_scale, mesh_name, downsample_level)
...
if N <= 0
  fprintf(2, 'number of data is not positive\n');
end
