	...
	{
		{
			...
			ExtendedModel<ContactSpaceR2, flann::Index> extended_model = 
				constructExtendedModelForModelDecisionBoundary<ContactSpaceR2, MulticonlitronLearner, flann::Index, flann::KDTreeIndexParams>(contactspace, learner, support_samples, 0.01);
