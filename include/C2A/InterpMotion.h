...
public:
	...
	virtual double computeTOC2(PQP_REAL d, PQP_REAL r1, PQP_REAL p[3], PQP_REAL q[3]);
	...
	virtual double computeTOC_MotionBound(
	    ...
	    PQP_REAL d,
	    C2A_BV *V,
	    PQP_REAL p[3], PQP_REAL q[3]);//using motion bound of RSS
